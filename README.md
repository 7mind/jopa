...
- **How compliant it with Java specifications?** That's a mystery bubblewrapped in an enigma. Usually JOPA spits out bytecode which looks like bytecode and runs like bytecode, but its typer is an abyss, don't stare into it. I think my dog is more compliant with Java specifications, but somehow JOPA works and builds complex projects.
