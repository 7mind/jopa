...
**Note:** All target versions work correctly. Target 1.7 (class file version 51.0) generates correct StackMapTable attributes required by Java 7+ verification, passing 100% of tests. Generated class files require at least the corresponding JVM major version.
