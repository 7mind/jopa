...
if [[ "$JDK_VERSION" == "jdk7" ]]; then
    ...
    SOURCE_VERSION="1.7"
    LIB_DIRS="${ASSETS_DIR}/com/sun/javadoc/lib:${ASSETS_DIR}/tools/javac/lib:${ASSETS_DIR}/tools/apt/lib:${ASSETS_DIR}/tools/javac/api/lib:${ASSETS_DIR}/tools/javadoc/lib"
else
